...
sealed class SubAccountRecyclerClick(val account: Account, val subAccount: SubAccount) {
    ...
    class EditAssociation(account: Account, subAccount: SubAccount, val association: Association, val sourceType: SourceType) : SubAccountRecyclerClick(account, subAccount)
